<div x-data="{ open: false }" class="w-full">
    <div :class="{ 'block': !open, 'hidden': open }" @click="open = !open"
        ...
        <img class="w-full border-2 border-black rounded-lg"
            src="https://wordlewebsite.com/upload/cache/upload/imgs/diffle-m190x110.png" alt="Wordle Game">
        <p class="text-black text-3xl font-semibold text-center mt-3 mb-3">Diffle</p>
    </div>
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden flex flex-col md:flex-row items-start gap-5 flex-grow relative w-full">
        <div class="w-full md:w-3/4">
            <p @click="open = !open"
                ...
                src="https://wordlewebsite.com/game/diffle.embed" frameborder="0" scrolling="no" allowfullscreen="yes">
            </iframe>
